...
public class DeleteCommentVisitorAction extends Action {

	private UserDAO userDAO;
	private PostDAO postDAO;
	private CommentDAO commentDAO;

	public DeleteCommentVisitorAction(Model model) {
	...
	public String getName() {
		return "deleteCommentVisitor.do";
	}
			...
			if (commentIdStr != null) {
				...
				if (comments != null) {
                    ...
                    if(userEmail.equals(user.getEmail())){
						...
						if (comments.getCommentEmail().equals(user.getEmail())) {
	                        commentDAO.delete(commentId);
	                    // can delete everyone's comment if from home page ( <=> userEmail == null)
						}
						else{
							errors.add("Cannot delete others' comment ");
						}
					}
				}
				Transaction.commit();
