	...
	public String performPost(HttpServletRequest request) {
		...
		try {
			...
			if (postIdStr != null) {
				...
				if ((postBean != null) && (postBean.getPostEmail().equals(user.getEmail()))) {

					CommentBean[] commentList = commentDAO.match(MatchArg.equals("postId", postId));
